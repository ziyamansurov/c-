...
class Program
{
    ...
    public static void kvtenliy()
    {
        ...
        ilkemsal = Convert.ToDouble(Console.ReadLine());
        Console.WriteLine("quvvet 1 i daxil edin");
        q1 = Convert.ToDouble(Console.ReadLine());
        Console.WriteLine("ikinciemsali daxil edin");
        ikinciemsal = Convert.ToDouble(Console.ReadLine());
        Console.WriteLine("quvvet 2 ni daxil edin");
        q2 = Convert.ToDouble(Console.ReadLine());
        Console.WriteLine("ucuncuemsal daxil edin");
        ucuncuemsal = Convert.ToDouble(Console.ReadLine());

        double a = ilkemsal, b = ikinciemsal, c = ucuncuemsal;
        Console.WriteLine("{0}x,{1}-{2}x,{3}-{4}=0", ilkemsal, q1, ikinciemsal, q2, ucuncuemsal);
        if (q1 == 2 && q2 == 1 && c != 0)
        {
        ...
        //Console.WriteLine("{0}x,{1}-{2}x,{3}={4}", ilkemsal * q1, q1 - 1, ikinciemsal * q2, q2 - 1, 0);
        //Console.WriteLine("{0}x,{1}-{2}x,{3}={4}", ilkemsal * q1, q1 - 1, ikinciemsal * q2, q2 - 1, serbesthed);
        // Console.WriteLine("{0}x1={1}x2",serbesthed/ilkemsal,);
        //x1*x1-x2=10
        //ax3-ax2=c
